                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <div class="form-check form-check-inline font-size-16">
                        ...
                        >
                          <i class="fab fa-cc-paypal me-1 font-size-20 align-top"></i>{" "}
                          Paypal
                        </label>
                      </div>
                      <div class="form-check form-check-inline font-size-16">
                        ...
                        >
                          <i class="far fa-money-bill-alt me-1 font-size-20 align-top"></i>{" "}
                          Cash on Delivery
                        </label>
                      </div>
                    </div>
                        ...
                        <table class="table align-middle mb-0 table-nowrap">
                          ...
                          <tbody>
                            <tr>
                              <th scope="row">
                                <img
                                  src="{% static 'images/product/img-1.png' %}"
                                  alt="product-img"
                                  title="product-img"
                                  class="avatar-md"
                                />
                            ...
                            <tr>
                              <th scope="row">
                                <img
                                  src="{% static 'images/product/img-7.png' %}"
                                  alt="product-img"
                                  title="product-img"
                                  class="avatar-md"
                                />
