  ...
  return (
    <>
      ...
      <div className="container mt-5 ">
        <h2 className="text-center pt-2">{t("need_help")} ?</h2>
        <div class="checkout-tabs" style={{ marginTop: "20px" }}>
          <div class="row">
            <div class="col-lg-2">
              <div
              ...
              >
                ...
                >
                  ...
                  <p class="fw-bold mb-4">{t("general_questions")}</p>
                </a>
                <a
                  class="nav-link"
                ...
                >
                  ...
                  <p class="fw-bold mb-4">{t("privacy_policy")}</p>
                </a>
                <a
                  class="nav-link"
              ...
              <div class="card">
                <div class="card-body">
                  <div class="tab-content" id="v-pills-tabContent">
                    ...
                    >
                      <h4 class="card-title mb-5">{t("general_questions")}</h4>
                    ...
                    >
                      <h4 class="card-title mb-5">{t("privacy_policy")}</h4>
